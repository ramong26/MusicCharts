...
export default function SubmitPlaylist() {
  // ✅ 초기값: 테스트하고 싶은 플레이리스트 URL
  const defaultPlaylistUrl = 'https://open.spotify.com/playlist/6kVEeyek3h3P1eZZMxRQgD';

  const [submitUrl, setSubmitUrl] = useState(defaultPlaylistUrl);
  ...
  // ✅ 페이지 열리면 자동으로 제출
  useEffect(() => {
    handleSubmit(defaultPlaylistUrl);
  }, []);
